...
# The Python package normalizes input to mono 16 kHz PCM WAV before this
# legacy pipeline starts, removing the user-facing SoX dependency.
...
bash runtime/pipeline/prepare_new_lang.sh $dict_dir $lang_dir "<UNK>" &>/dev/null
